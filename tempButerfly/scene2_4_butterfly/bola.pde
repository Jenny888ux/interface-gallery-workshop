class Bola {
  ...
  void display() {
    if (!aparece) {
      ...
      fill(255, noiseVal*12*10);
      ellipse(x, y, 200/(noiseVal*9), 200/(noiseVal*9));

      fill(255, noiseVal*14*10);
      ellipse(x, y, 200/(noiseVal*12), 200/(noiseVal*12));
      ...
      fill(255, noiseVal*30*10);
      ellipse(x, y, 200/(noiseVal*50), 200/(noiseVal*50));

      fill(255, noiseVal*50*10);
