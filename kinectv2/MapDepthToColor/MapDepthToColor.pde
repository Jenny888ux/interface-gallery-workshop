...
void setup() {
  ...
  kHD = KinectPV2.HEIGHTDepth;
  kWD = KinectPV2.WIDTHDepth;

  depthToColorImg = createImage(kWD, kHD, RGB); //(512, 424, PImage.RGB);
  depthZero    = new int[kWD * kHD];
...
void draw() {
  ...
  image(kinect.getColorImage(), 0, 0, 512, 288);
